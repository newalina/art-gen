...
class AGD_TouchDesignerPatch(Enum):
    ...
    TD_PATCH_FILES      = ['"' + AGD_DEF.ROOT_DIR.value + AGD_DEF.TD_DIR.value + '\\Patches\\none.toe"',
                           '"' + AGD_DEF.ROOT_DIR.value + AGD_DEF.TD_DIR.value + '\\Patches\\hex-quakes.toe"',
                           '"' + AGD_DEF.ROOT_DIR.value + AGD_DEF.TD_DIR.value + '\\Patches\\reserved-2.toe"',
                           '"' + AGD_DEF.ROOT_DIR.value + AGD_DEF.TD_DIR.value + '\\Patches\\reserved-3.toe"',
                           '"' + AGD_DEF.ROOT_DIR.value + AGD_DEF.TD_DIR.value + '\\Patches\\reserved-4.toe"',
                           '"' + AGD_DEF.ROOT_DIR.value + AGD_DEF.TD_DIR.value + '\\Patches\\reserved-5.toe"',
                           '"' + AGD_DEF.ROOT_DIR.value + AGD_DEF.TD_DIR.value + '\\Patches\\reserved-6.toe"',
                           '"' + AGD_DEF.ROOT_DIR.value + AGD_DEF.TD_DIR.value + '\\Patches\\reserved-7.toe"',
                           '"' + AGD_DEF.ROOT_DIR.value + AGD_DEF.TD_DIR.value + '\\Patches\\reserved-8.toe"']
...
#execStr = AGD_DEF.TD_EXEC.value + " " + AGD_TouchDesignerPatch.TD_PATCH_RESERVED_1.value;
